# Subteam report: compiler 2016-03-04

## Highlights

We discussed the current regressions in compile-time errors, as well
as some older cases. Mostly these have to do with attempting to
recover from earlier errors, leading to erroneous follow-on reports.
We'll be making some efforts to tamp these down until we can make the
overall error recovery mechanism more reliable.
